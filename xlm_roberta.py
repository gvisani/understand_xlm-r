...
if __name__ == '__main__':
    ...
    # Mix of languages for attention visualization experiments. We created these files ourselves
    ...
    with open('../sentences_english_experiment_with_base_embeddings.pkl', 'wb') as f:
